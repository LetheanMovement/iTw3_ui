...
export const RCV_ADDR_QR_SCALE: number = 1.5;  // scale factor for QR code
...
export const BLOCK_EXPLORER_TX_URL_PREFIX: string = 'explorer.lt.hn/transaction/';
export const BLOCK_EXPLORER_TN_TX_URL_PREFIX: string = 'explorer.lt.hn/transaction/';
